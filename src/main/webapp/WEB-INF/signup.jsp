        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="file-field input-field col s6">
                    <div class="btn">
                        <span>File</span>
                        <input type="file" name="reg-avatar" id="reg-avatar">
                    </div>
            ...
            <button style="color: white; margin-top: 5%; width: 100%" class="btn waves-effect waves-light red darken-2 offset-s1" type="submit">
